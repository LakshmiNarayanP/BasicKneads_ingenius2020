...
class HomePage_Drinks extends StatefulWidget {
  @override
  _HomePage_DrinksState createState() => _HomePage_DrinksState();
}

class _HomePage_DrinksState extends State<HomePage_Drinks> {
  @override
