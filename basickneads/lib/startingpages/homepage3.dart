...
class HomePage_Snacks extends StatefulWidget {
  @override
  _HomePage_SnacksState createState() => _HomePage_SnacksState();
}

class _HomePage_SnacksState extends State<HomePage_Snacks> {
  @override
